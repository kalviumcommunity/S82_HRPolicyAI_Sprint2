...
if __name__ == "__main__":
    try:
        ...
        print("To generate embeddings via the API, configure OPENAI_API_KEY in rag-app-starter/.env.")
        print("For offline embedding quality tests, run: python src/embedding_quality_checks.py")